...
Before deploying, you need to setup fast_remote_cache.  The necessary setup steps are completed after you run deploy:setup or, if you'd prefer to simply setup the fast_remote_cache strategy, run:

  cap fast_remote_cache:setup
